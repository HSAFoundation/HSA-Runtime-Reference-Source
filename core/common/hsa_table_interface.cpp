...
hsa_status_t HSA_API
  ...
  return HsaApiTable->hsa_system_get_extension_table(
...
hsa_status_t HSA_API
    hsa_iterate_agents(hsa_status_t (*callback)(hsa_agent_t agent, void *data),
                       void *data) {
  return HsaApiTable->hsa_iterate_agents(callback, data);
}

hsa_status_t HSA_API hsa_agent_get_info(hsa_agent_t agent,
                                        hsa_agent_info_t attribute,
                                        void *value) {
  return HsaApiTable->hsa_agent_get_info(agent, attribute, value);
}

hsa_status_t HSA_API hsa_agent_get_exception_policies(hsa_agent_t agent,
                                                      hsa_profile_t profile,
                                                      uint16_t *mask) {
  return HsaApiTable->hsa_agent_get_exception_policies(
      agent, profile, mask);
}
...
hsa_status_t HSA_API
    hsa_agent_extension_supported(uint16_t extension, hsa_agent_t agent,
                                  ...
                                  uint16_t version_minor, bool *result) {
  return HsaApiTable->hsa_agent_extension_supported(
...
hsa_status_t HSA_API
  ...
  return HsaApiTable->hsa_queue_create(
...
uint64_t HSA_API hsa_queue_cas_write_index_acq_rel(const hsa_queue_t *queue,
                                                   uint64_t expected,
                                                   uint64_t value) {
  return HsaApiTable->hsa_queue_cas_write_index_acq_rel(
...
uint64_t HSA_API hsa_queue_cas_write_index_acquire(const hsa_queue_t *queue,
                                                   uint64_t expected,
                                                   uint64_t value) {
  return HsaApiTable->hsa_queue_cas_write_index_acquire(
      queue, expected, value);
}
...
uint64_t HSA_API hsa_queue_cas_write_index_relaxed(const hsa_queue_t *queue,
                                                   uint64_t expected,
                                                   uint64_t value) {
  return HsaApiTable->hsa_queue_cas_write_index_relaxed(
      queue, expected, value);
}
...
hsa_status_t HSA_API hsa_agent_iterate_regions(
  ...
  return HsaApiTable->hsa_agent_iterate_regions(agent, callback,
                                                              data);
}
...
hsa_signal_value_t HSA_API
  ...
  return HsaApiTable->hsa_signal_wait_relaxed(
...
hsa_signal_value_t HSA_API hsa_signal_cas_acquire(hsa_signal_t signal,
                                                  hsa_signal_value_t expected,
                                                  hsa_signal_value_t value) {
  return HsaApiTable->hsa_signal_cas_acquire(signal, expected,
                                                           value);
}
...
hsa_signal_value_t HSA_API hsa_signal_cas_release(hsa_signal_t signal,
                                                  hsa_signal_value_t expected,
                                                  hsa_signal_value_t value) {
  return HsaApiTable->hsa_signal_cas_release(signal, expected,
                                                           value);
}
...
hsa_signal_value_t HSA_API hsa_signal_cas_acq_rel(hsa_signal_t signal,
                                                  hsa_signal_value_t expected,
                                                  hsa_signal_value_t value) {
  return HsaApiTable->hsa_signal_cas_acq_rel(signal, expected,
                                                           value);
}
...
hsa_status_t hsa_isa_from_name(
  ...
  return HsaApiTable->hsa_isa_from_name(name, isa);
}
...
hsa_status_t HSA_API hsa_isa_get_info(
  ...
  return HsaApiTable->hsa_isa_get_info(
...
hsa_status_t hsa_isa_compatible(
  ...
  return HsaApiTable->hsa_isa_compatible(
...
hsa_status_t HSA_API hsa_code_object_serialize(
  ...
  return HsaApiTable->hsa_code_object_serialize(
    code_object,
    alloc_callback,
    callback_data,
    options,
...
hsa_status_t HSA_API hsa_code_object_deserialize(
  ...
  return HsaApiTable->hsa_code_object_deserialize(
    serialized_code_object,
    serialized_code_object_size,
    options,
    code_object
...
hsa_status_t HSA_API hsa_code_object_destroy(
  ...
  return HsaApiTable->hsa_code_object_destroy(code_object);
}
...
hsa_status_t HSA_API hsa_code_object_get_info(
  ...
  return HsaApiTable->hsa_code_object_get_info(
...
hsa_status_t HSA_API hsa_code_object_get_symbol(
  ...
  return HsaApiTable->hsa_code_object_get_symbol(
...
hsa_status_t HSA_API hsa_code_symbol_get_info(
  ...
  return HsaApiTable->hsa_code_symbol_get_info(
...
hsa_status_t HSA_API hsa_code_object_iterate_symbols(
  ...
  return HsaApiTable->hsa_code_object_iterate_symbols(
...
hsa_status_t HSA_API hsa_executable_create(
  ...
  return HsaApiTable->hsa_executable_create(
...
hsa_status_t HSA_API hsa_executable_destroy(
  ...
  return HsaApiTable->hsa_executable_destroy(executable);
}
...
hsa_status_t HSA_API hsa_executable_load_code_object(
  ...
  return HsaApiTable->hsa_executable_load_code_object(
...
hsa_status_t HSA_API hsa_executable_freeze(
  ...
  return HsaApiTable->hsa_executable_freeze(executable, options);
}
...
hsa_status_t HSA_API hsa_executable_get_info(
  ...
  return HsaApiTable->hsa_executable_get_info(
...
hsa_status_t HSA_API hsa_executable_global_variable_define(
  ...
  return HsaApiTable->hsa_executable_global_variable_define(
...
hsa_status_t HSA_API hsa_executable_agent_global_variable_define(
  ...
  return HsaApiTable->hsa_executable_agent_global_variable_define(
...
hsa_status_t HSA_API hsa_executable_readonly_variable_define(
  ...
  return HsaApiTable->hsa_executable_readonly_variable_define(
    executable, agent, variable_name, address
  );
}
...
hsa_status_t HSA_API hsa_executable_validate(
  ...
  return HsaApiTable->hsa_executable_validate(
    executable, result
  );
}
...
hsa_status_t HSA_API hsa_executable_get_symbol(
  ...
  return HsaApiTable->hsa_executable_get_symbol(
...
hsa_status_t HSA_API hsa_executable_symbol_get_info(
  ...
  return HsaApiTable->hsa_executable_symbol_get_info(
...
hsa_status_t HSA_API hsa_executable_iterate_symbols(
  ...
  return HsaApiTable->hsa_executable_iterate_symbols(
...
hsa_status_t HSA_API
  ...
  return HsaApiTable->hsa_status_string(status, status_string);
}
